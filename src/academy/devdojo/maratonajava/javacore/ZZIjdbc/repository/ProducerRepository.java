    ...
    private static void preparedStatementSaveTransaction(Connection conn, List<Producer> producers) throws SQLException {
        ...
        for (Producer p : producers) {
            try (PreparedStatement ps = conn.prepareStatement(sql)) {
                log.info("Savindo producer '{}'", p.getName());
...
//                if(p.getName().equals("White Fox")) throw new SQLException("Can't save white fox");
    ...
    public static List<Producer> findByNameAndUpdateToUpperCase(String name) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            while (rs.next()) {
                ...
                // rs.cancelRowUpdates(); -> sempre que quiser voltar ao estado anterior ^
                rs.updateRow();
                Producer producer = Producer
                        .builder()
                        .id(rs.getInt("id"))
    ...
    private static void getName(String name, ResultSet rs) throws SQLException {
